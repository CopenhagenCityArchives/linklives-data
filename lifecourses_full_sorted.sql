SELECT
	LC.life_course_id,
	L.*,
	coalesce(C45.navn, '') || coalesce(C50.navn, '') || coalesce(C60.navn, '') as navn,
	coalesce(C45.køn, '') || coalesce(C50.køn, '') || coalesce(C60.køn, '') as køn,
	coalesce(C45.alder, '') || coalesce(C50.alder, '') || coalesce(C60.alder, '') as alder,
	coalesce(C45.fødested, '') || coalesce(C50.fødested, '') || coalesce(C60.fødested, '') as fødested,
	coalesce(C45.Sogne, '') || coalesce(C50.Sogne, '') || coalesce(C60.Sogne, '') as Sogne,
	coalesce(C45.Amt, '') || coalesce(C50.Amt, '') || coalesce(C60.Amt, '') as Amt,
	coalesce(C45.Herred, '') || coalesce(C50.Herred, '') || coalesce(C60.Herred, '') as Herred,
	...
	coalesce(C45.gender_clean, '') || coalesce(C50.gender_clean, '') || coalesce(C60.gender_clean, '') as gender_clean,
	...
	coalesce(C45.first_name_std, '') || coalesce(C50.first_name_std, '') || coalesce(C60.first_name_std, '') as first_name_std,
	coalesce(C45.last_name_std, '') || coalesce(C50.last_name_std, '') || coalesce(C60.last_name_std, '') as last_name_std,
